# Agent Instructions for Neurosymbolic

## Project Context
Neurosymbolic is an open source Bridge neural and symbolic AI with differentiable logic.

## Repository Layout
- `src/aumai_neurosymbolic/` — package source
